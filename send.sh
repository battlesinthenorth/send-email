...
Buenos dias, se adjunta reporte diario de inventarios SIDRA automatizado. Para la correcta visualizacion del archivo, favor de seleccionar la opcion de exportar de filas a columnas en Excel, seleccionar toda la columna A y colocar el caracter "|" . Saludos.
